    ...
    $(document).on('click', '.view-details-btn', function () {
        ...
        let content = `
            ...
            <div class="col-span-2">
                ...
                <a href="/patient/${patientData.patient_id}/results/virtual-notes" class="bg-gray-50 p-3 rounded text-center hover:shadow-lg hover:bg-white">
                ...
                <a href="/patient/${patientData.patient_id}/results/clinical-notes" class="bg-gray-50 p-3 rounded text-center hover:shadow-lg hover:bg-white">
                ...
                <a href="/patient/${patientData.patient_id}/results/e-prescription" class="bg-gray-50 p-3 rounded text-center hover:shadow-lg hover:bg-white">
                ...
                <a href="/patient/${patientData.patient_id}/results/quest-lab" class="bg-gray-50 p-3 rounded text-center hover:shadow-lg hover:bg-white">
