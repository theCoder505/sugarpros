...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'patient_loggedin' => \App\Http\Middleware\Patient::class,
        'check_if_forms_filled' => \App\Http\Middleware\AggreementsFilledUpMiddleware::class,
        'check_if_provider' => \App\Http\Middleware\ProviderSignedUP::class,
        ...
        'biller-admin' => \App\Http\Middleware\BillerAdminMiddleware::class,
