    ...
    <section>
        <div class="max-w-full md:min-h-[250px] flex justify-center items-center bg-[#133A59]/10 px-4 py-8 mx-auto">
            <div class="text-center">
                <h1 class="mb-2 text-[40px] text-[#133A59]">Our Services
                </h1>
    ...
    <section class="py-12 mx-auto bg-white">
        <div class="text-center max-w-[530px] mx-auto mb-12">
            ...
            <p class="mt-3 text-gray-800 text-[15px]">Comprehensive virtual care designed for real life—because managing
                diabetes
                shouldn’t feel like a second job.</p>
        ...
        <div class="space-y-16">
            <div class="md:py-8">
                <div class="flex flex-col items-center max-w-5xl gap-6 p-6 mx-auto md:flex-row">
                    <img src="{{ asset('assets/image/se1.png') }}" alt="Continuous Health Monitoring"
                        class="w-full md:max-h-[400px] md:w-1/2 rounded-xl shadow-sm">
                    <div class="md:w-1/2">
                        <h3 class="text-[35px] font-semibold text-font_color">Continuous Health Monitoring</h3>
            ...
            <div class=" bg-[#FF6500]/10 md:py-8">
                <div class="flex flex-col-reverse items-center max-w-5xl gap-6 p-6 mx-auto md:flex-row rounded-xl">
                    <div class="md:w-1/2">
                        <h3 class="text-[35px] font-semibold text-font_color">Virtual Specialist Visits</h3>
                        <p class="text-[15px] text-gray-500">Specialist care from your couch</p>
                        <ul class="list-disc pl-5 mt-3 space-y-4 text-gray-600 text-[15px]">
                            <li><strong>Video Consultations:</strong> HIPAA-secure Zoom visits with specialists.</li>
                    ...
                    <img src="{{ asset('assets/image/se2.png') }}" alt="Virtual Specialist Visits"
            ...
            <div class="md:py-8">
                <div class="flex flex-col items-center max-w-5xl gap-6 p-6 mx-auto md:flex-row">
                    <img src="{{ asset('assets/image/se3.png') }}" alt="SugarPros AI Assistant"
                        class="w-full md:max-h-[400px] md:w-1/2 rounded-xl shadow-sm">
                    <div class="md:w-1/2">
                        <h3 class="text-[35px] font-semibold text-font_color">SugarPros AI Assistant</h3>
                        <p class="text-[15px] text-gray-500">Your 24/7 diabetes coach</p>
                        <ul class="list-disc pl-5 mt-3 space-y-4 text-gray-600 text-[15px]">
                            <li><strong>Symptom Checker:</strong> Ask things like, “Why am I dizzy after meals?”</li>
                            <li><strong>Nutrition Guidance:</strong> “What’s a low-carb snack for work?”</li>
    ...
    <section class="bg-[#0e3757] md:rounded-2xl   md:mx-16 md:my-12 overflow-hidden">
        <div class="grid items-center grid-cols-1 gap-8 mx-auto max-w-7xl md:grid-cols-2">
            ...
            <div class="max-w-1/2">
                ...
                <img src="{{ asset('assets/image/doctor.png') }}" alt="Doctor"
                    class="relative z-10 w-auto max-h-[300px]">
            </div>
