                            ...
                            @foreach ($appointment['virtual_notes'] as $note)
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            <p class="font-medium text-gray-700">{{ $note->main_note }}</p>
                            ...
                            @foreach ($appointment['clinical_notes'] as $note)
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <a href="/admin/clinical-notes/{{ $appointment['appointmentData'][0]->appointment_uid }}/{{ $note->id }}"
                            ...
                            @foreach ($appointment['questlab_notes'] as $note)
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <a href="/admin/quest-lab/{{ $appointment['appointmentData'][0]->appointment_uid }}/{{ $note->id }}"
                                            class="flex items-center gap-1 px-2 py-1 text-xs bg-blue-50 text-blue-700 rounded hover:bg-blue-100 transition-colors">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                    </div>
                            ...
                            @foreach ($appointment['eprescription_notes'] as $note)
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <a href="/admin/e-prescription/{{ $appointment['appointmentData'][0]->appointment_uid }}/{{ $note->id }}"
                                            class="flex items-center gap-1 px-2 py-1 text-xs bg-blue-50 text-blue-700 rounded hover:bg-blue-100 transition-colors">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                    </div>
