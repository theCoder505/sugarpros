        ...
        <div class="min-h-screen bg-[#f4f6f8] p-4">
            ...
            <div class="py-5 bg-gray-100 ">
                <div class="p-8 mx-auto overflow-hidden bg-white shadow-md rounded-xl">
                    <form class="space-y-6" action="/provider/update-quest-lab" method="POST">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input type="text" name="test_name" value="{{ $test_name }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="test_code" value="{{ $test_code }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="specimen_type" value="{{ $specimen_type }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                                <label class="block mb-1 text-sm font-medium text-gray-700">Urgency</label>
                                <input type="text" name="urgency" value="{{ $urgency }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                                <label class="block mb-1 text-sm font-medium text-gray-700">Preferred Lab Location</label>
                                <input type="text" name="preferred_lab_location" value="{{ $preferred_lab_location }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="clinical_notes" value="{{ $clinical_notes }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                                <label class="block mb-1 text-sm font-medium text-gray-700">Patient Phone No</label>
                                <input type="text" name="patient_phone_no" value="{{ $patient_phone_no }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                                <label class="block mb-1 text-sm font-medium text-gray-700">Insurance Provider </label>
                                <input type="text" name="insurance_provider" value="{{ $insurance_provider }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                            <div>
                                <label class="block mb-1 text-sm font-medium text-gray-700">Estimated Cost</label>
                                <input type="text" name="estimated_cost" value="{{ $estimated_cost }}" required
                                    placeholder="Type here"
                                    class="w-full  bg-white placeholder:text-[#A3A3A3] px-3 py-2 mt-1 border  border-gray-300 rounded-md outline-none">
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 justify-end">
                            ...
                            <button type="button"
                                onclick="if(confirm('Are you sure you want to delete this lab?')){ this.form.action='/provider/delete-quest-lab/{{ $questid }}'; this.form.submit(); }"
