...
@section('title', 'Virtual Note Records')
...
@section('content')
    ...
    <div class="clinical-notes-container">
        <h1 class="page-title">
            <i class="fas fa-clipboard"></i> Virtual Note Records
        </h1>
        ...
        @if (count($virtual_notes) > 0)
            <div class="notes-list">
                @foreach ($virtual_notes as $note)
                    <div class="note-card" data-appointmentid="{{ $note->appointment_uid }}">
                        <div class="note-content">
                            ...
                            @if ($note->main_note)
                                <div class="note-section">
                                    <div class="note-section-title">Virtual Note</div>
                                    <div class="note-section-content">{{ $note->main_note }}</div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="{{ url('/provider/view-appointment/' . $note->appointment_uid) }}"
                                class="view-details-btn bg-slate-800 w-full">
                                <i class="fas fa-eye"></i> Appointment
                            </a>
                            <a href="{{ url('/provider/virtual-notes/' . $note->appointment_uid . '/' . $note->id) }}"
        ...
        @else
            <div class="empty-state">
                ...
                <h3>No Virtual Notes Found</h3>
                <p>You haven't created any virtual notes for this patient yet.</p>
            </div>
        @endif
