        ...
        <div class=" bg-[#f4f6f8] p-4">
            ...
            <form class="space-y-6" action="/provider/update-e-prescription" method="POST">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="time_duration" required placeholder="Type here"
                                        min="1" max="365" maxlength="3" value="{{ $time_duration }}"
                ...
                <div class="flex gap-4 justify-end">
                    ...
                    <button type="button"
                        onclick="if(confirm('Are you sure you want to delete this lab?')){ this.form.action='/provider/delete-eprescription/{{ $prescription_id }}'; this.form.submit(); }"
