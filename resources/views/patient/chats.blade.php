        ...
        <div class="grid grid-cols-1 p-4 mx-auto bg-white rounded-xl lg:grid-cols-3 chating_section relative">
            <div class="flex flex-col col-span-1 px-4 mb-4 border rounded-md lg:border-none lg:mb-0 lg:rounded-none">
                ...
                <div class="flex-grow chat-list-container">
                    <h2 class="text-[16px] text-[#000000] font-semibold my-2">Providers For You</h2>
                    ...
                    <div class="overflow-y-auto py-2 users_list">
                        @forelse ($related_providers as $provider)
                            <div class="flex items-center justify-between px-2 py-5 mb-2 bg-gray-100 rounded-lg cursor-pointer chat-item @if ($provider->message_status == 'delivered' && $provider->is_sender != Auth::user()->patient_id) unread @endif"
                                data-id="{{ $provider->provider_id }}" onclick="showMessage(this)">
                                ...
                                <div class="flex items-center gap-3 provider_details">
                                    ...
                                    <div class="name_section">
                                        <p class="font-semibold text-[16px] provider_name">
                                            ...
                                            <span class="designation capitalize">
                                                |
                                ...
                                <div class="flex flex-col items-end timeandseen">
                                    @if ($provider->message_time)
                                        <span class="text-xs text-gray-400 msg_time">
                                            {{ \Carbon\Carbon::parse($provider->message_time)->format('H:i') }}
                                        </span>
                                    @endif
                ...
                <div class="flex col-span-2 flex-col bg-gray-100 rounded-t-[16px] message-container make_hide">
                    ...
                    <div class="px-4 mb-4 message_sending relative hidden">
                        ...
                        <div class="p-4 rounded-[10px] bg-white gap-2">
                            ...
                            <div class="flex items-center justify-between w-full">
                                ...
                                <input type="hidden" class="user_type" value="patient">
                                <input type="hidden" class="patient_id" value="{{ Auth::user()->patient_id ?? '' }}">
