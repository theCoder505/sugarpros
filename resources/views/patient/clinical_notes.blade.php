        ...
        <div class="max-w-6xl mx-auto">
                ...
                <div class="bg-white p-4 rounded-lg shadow-sm border-l-4 border-blue-500">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <h3 class="text-2xl font-bold">{{ count(array_unique($finalClinicalNotes->pluck('note_by_provider_id')->toArray())) }}</h3>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <div class="note-card bg-white p-4 border-b mb-4 last:border-b-0 result_line cursor-pointer"
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3">
                            <a href="/patient/show-appointment/{{$note->appointment_uid}}" class="status-badge bg-indigo-100 text-indigo-800">
                ...
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500">You don't have any clinical notes yet. Notes from your provider will appear here after your appointments.</p>
                </div>
                @endforelse
            </div>
            ...
            <div class="mt-8 bg-indigo-50 rounded-lg p-6">
                <div class="flex flex-col md:flex-row md:items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mb-2">If you have questions about your medical documentation or need clarification, please contact your healthcare provider.</p>
                        <div class="flex gap-3">
                            <a href="recent-chat" class="text-sm text-indigo-600 font-medium hover:underline flex items-center gap-1">
