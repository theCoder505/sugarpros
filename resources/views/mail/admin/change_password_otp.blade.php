                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; margin-top: 40px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="padding: 40px 30px 20px 30px; text-align: center;">
                            <h2 style="color: #1C3B6F;">🔐 Password Change Verification (OTP)</h2>
                            <p style="font-size: 16px; color: #333;">
                                Dear SugarPros Admin,<br>
                                You have requested to change your account password from the account settings page of {{ $brandname }}.<br>
                                Please use the following 6-digit OTP to verify your request and complete the password change process.
                            </p>
